					...
					array(
						...
						'pages' => array(
							array(
								...
								'page_title'      => apply_filters('ot_theme_options_page_title', __('Airbn Admin', 'option-tree')),
								'menu_title'      => apply_filters('ot_theme_options_menu_title', __('Airbn Admin', 'option-tree')),
